...
from acsl_pychrono.control.ReLuMRAC.m_relu_mrac import M_ReLuMRAC
...
class FunnelReLuMRAC(BaseMRAC, Control):
  ...
  def computeControlAlgorithm(self, ode_input: OdeInput):
    ...
    self.Theta_hat_tran_ReLu = self.y[107:107 + (self.gains.NN_width * self.gains.B_ref_tran.shape[1])] # \hat{\Theta} (translational - Neural Network) 
    ...
    # Compute \Phi for the nerual network
