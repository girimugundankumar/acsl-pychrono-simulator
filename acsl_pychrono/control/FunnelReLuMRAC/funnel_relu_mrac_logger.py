...
from acsl_pychrono.control.FunnelReLuMRAC.funnel_relu_mrac_gains import FunnelReLuMRACGains
from acsl_pychrono.control.FunnelReLuMRAC.funnel_relu_mrac import FunnelReLuMRAC

class FunnelReLuMRACLogger:
  def __init__(self, gains: FunnelReLuMRACGains) -> None:
    self.gains = gains
    self.data_list = []
    # Length of the array vector that will be exported 
    self.size_DATA = 197

  def collectData(self, controller: FunnelReLuMRAC, simulation_time: float):
