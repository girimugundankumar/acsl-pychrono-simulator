...
from acsl_pychrono.control.ReLuMRAC.relu_mrac import ReLuMRAC

class ReLuMRACLogger:
  def __init__(self, gains: ReLuMRACGains) -> None:
    self.gains = gains
    self.data_list = []
    # Length of the array vector that will be exported 
    self.size_DATA = 181

  def collectData(self, controller: ReLuMRAC, simulation_time: float):
